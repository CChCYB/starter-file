...
<template>
  <div class="mt-4 grid grid-cols-3 gap-2">
    ...
    <div>
      <button v-on:click="search" class="bg-gray-800 opacity-75 hover:bg-purple-500 hover:text-white rounded-md border py-2 px-4 font-medium text-lg border-gray-900">查找</button>
    </div>
  </div>
</template>